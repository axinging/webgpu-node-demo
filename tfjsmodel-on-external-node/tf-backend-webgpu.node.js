...
var WebGPUBackend = /** @class */ (function (_super) {
    ...
    WebGPUBackend.prototype.uploadToGPU = function (dataId) {
        ...
        if (tensorData.values) {
            ...
            var unmappedState = tf.device_util.isBrowser() ? buffer.mapState === 'unmapped' : true;
...
if (isWebGPUSupported()) {
    tf.registerBackend('webgpu', function () { return __awaiter(void 0, void 0, void 0, function () {
        var gpuDescriptor, adapter, _a, deviceDescriptor, adapterLimits, device, adapterInfo, _b;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    ...
                    if (!tf.device_util.isBrowser()) return [3 /*break*/, 2];
                    return [4 /*yield*/, navigator.gpu.requestAdapter(gpuDescriptor)];
                case 1:
                    _a = _c.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, getNodeGPU().requestAdapter(gpuDescriptor)];
                case 3:
                    _a = _c.sent();
                    _c.label = 4;
                case 4:
                ...
                case 5:
                    device = _c.sent();
                    if (!tf.device_util.isBrowser()) return [3 /*break*/, 7];
...
function softmax(args) {
    ...
    var program = new SoftmaxProgram(logits.shape);
    var b = backend.runWebGPUProgram(program, [logits, maxLogitsReshaped], logits.dtype);
